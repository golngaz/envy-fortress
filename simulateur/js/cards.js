 ...
 * -----------------------------------------------------------------------------
 *  Aide-mémoire pour les JOUEURS. Le recto montre l'identité (nom, type, coût,
 *  dé, ambiance) ; le verso montre le tableau de résolution. Clic = flip 3D.
 * ===========================================================================*/
window.Cards = (function () {

  const TYPE_LABEL = {
    attaque: "Attaque", defense: "Défense", soin: "Soin",
    passif: "Passif", shell: "Shell Control", utilitaire: "Utilitaire"
  };
  ...
  return { sortCard, armeCard, mobCard, TYPE_LABEL };
})();
